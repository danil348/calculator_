...
void menu::functionSelection(int menuIndex)
{
	...
	//case 2: Fractions(activeTheoryMenu); break; // äðîáè
	//case 3: Matrix(activeTheoryMenu); break; // ìàòðè÷íûé êàëüêóëÿòîð
	//case 4: Ñombinatoric(activeTheoryMenu); break; // êîìáèíàòîðèêà
